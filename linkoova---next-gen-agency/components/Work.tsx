...
import { ArrowRight, TrendingUp, Zap, Target, // Seulement les icônes nécessaires restent
...
// Browser Frame Component (Reste ici car il est spécifique au design de la page)
...
const Work: React.FC = () => {
  // Le tableau 'cases' est maintenant importé, ce qui rend cette section très légère.

  return (
    // Le conteneur principal de la page Work
    <div className="bg-[#0B0B0C] min-h-screen pt-32 pb-24 relative overflow-hidden">
      
      {/* 🛑 AUCUN CONFLIT 🛑 : Ce fond est ABSOLU/FIXE à l'intérieur de ce composant WORK. */}
