...
const testimonialsData = [
    {
        ...
        company: "Vortex SaaS",
        // Professional businessman portrait (Caucasian)
        image: "https://images.unsplash.com/photo-1556157382-97eda2d62296?auto=format&fit=crop&q=80&w=800&h=800" 
    },
    {
        quote: "Launching our product globally was terrifying. There were moments I thought we'd fail, but the Linkoova team was there at 2 AM fixing things before I could even panic. That level of commitment is rare. They saved us.",
        author: "Klaus Wagner",
        role: "Founder",
        company: "Spectra Logistics",
        // Image exacte demandée (ID: ml-pxK0Ovmw) - Homme en costume noir
        image: "https://images.unsplash.com/photo-1596075780750-81249df16d19?auto=format&fit=crop&q=80&w=800&h=800" 
    },
    {
        quote: "I used to drown in spreadsheets. The AI system they built didn't just improve 'efficiency' — it gave me my weekends back. My team is actually happy coming to work now. It's been a total game-changer.",
        author: "Amira El-Masri",
        role: "Director of Sales",
        // Nom d'entreprise plus réaliste
        company: "Equinox Financial",
        // Image exacte demandée (ID: razSQCqB-zw) - Femme en costume et cravate
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-4xl md:text-5xl text-white font-serif mb-4">
                        Our <span className="italic text-[#D1A954]">Stories</span>
                    </h2>
                    <p className="text-gray-400 max-w-xl mx-auto font-light text-sm md:text-base">
                        Behind every successful project, there are people. Here is what they think about their transformation.
                    </p>
                </div>
                            ...
                            <div className="relative mb-8">
                                ...
                                <div className="relative w-32 h-32 md:w-36 md:h-36 rounded-full overflow-hidden border-2 border-white/10 group-hover:border-[#D1A954] transition-colors duration-500 shadow-2xl">
                                    <img 
                                        ...
                                        onError={(e) => {
                                            // Fallback to a generated UI avatar if the image fails to load
