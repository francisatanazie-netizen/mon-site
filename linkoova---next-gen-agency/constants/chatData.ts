...
// Initialisation immédiate de la clé publique
...
const Quote: React.FC = () => {
  ...
  const sendAuditData = (allMessages: any[]) => {
    ...
    const templateParams = {
      ...
      header_tag: "LINKOOVA STRATEGIC INTELLIGENCE HUB",
      ...
      // Mapping des données (Basé sur ton chatData de 15 questions)
      company_name: userAnswers[0] || "Non spécifié",
      ...
      // Labels des sections pour le HTML
      label_identity: lang === 'FR' ? "Identité & Vision" : "Identity & Vision",
      label_market: lang === 'FR' ? "Analyse Marché" : "Market Analysis",
      label_audience: lang === 'FR' ? "Cible & Branding" : "Targeting & Branding",
      label_analysis: lang === 'FR' ? "Spécifications" : "Specifications",
      label_acquisition: lang === 'FR' ? "Défis & Gestion" : "Challenges & Management",
      label_specs: lang === 'FR' ? "Budget & Contact" : "Budget & Contact",

      // Pour le sujet de l'email
      project_universe: userAnswers[0] || "Nouveau Projet",
      budget_range: userAnswers[13] || "Standard"
    };
